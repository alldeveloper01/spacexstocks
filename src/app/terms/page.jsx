    ...
    <div style={{ background: '#000', minHeight: '100vh' }}>
      ...
      <div className="body">
        ...
        <div className="section">
          ...
          <p>Withdrawal requests are subject to manual review and approval by our compliance team within 24 hours. We reserve the right to request additional verification before processing withdrawal requests. Withdrawals may require completion of our KYC verification process at the discretion of our compliance team. KYC may be triggered based on account activity, transaction patterns, or other compliance requirements determined internally. Withdrawals are processed in the cryptocurrency selected by the user at the time of request, including TRX, USDT, BTC, ETH, BNB, SOL, XRP, and LTC.</p>
