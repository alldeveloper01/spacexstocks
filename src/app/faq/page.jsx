...
export const metadata = {
  ...
  keywords: ['SpaceX investment', 'how to invest in SpaceX', 'SpaceX IPO', 'SPCX stock', 'SpaceX shares', 'private SpaceX investment', 'SpaceX weekly returns', 'Starlink investment'],
  openGraph: {
    title: 'FAQ — SpaceX Stocks | How to Invest in SpaceX',
    description: 'Everything you need to know about investing through SpaceX Stocks. Weekly returns, crypto deposits, invitation codes, and member perks explained.',
